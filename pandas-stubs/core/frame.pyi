...
class DataFrame:
    ...
    @overload
    def apply(
        self, f: Callable[..., _ListLike], axis: _AxisType = ...
    ) -> DataFrame: ...
    def astype(
        self,
    ...
    @overload
    def drop(
        self, labels: Union[List[_str], Index], axis: _AxisType = ...
    ) -> DataFrame: ...
    @overload
    ...
    def from_records(
        self,
        data: Union[_np.ndarray, List[Tuple], Dict[_str, Any], DataFrame],
        index: Optional[Union[_str, List[_str]]] = ...,
        exclude: Optional[Sequence[_str]] = ...,
        columns: Optional[Sequence[_str]] = ...,
